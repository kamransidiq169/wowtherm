...
//     >
//       {/* Gradient-ring border: soft white ring at rest, warms to copper on hover */}
//       <div className="rounded-[1.75rem] bg-gradient-to-b from-white/15 via-white/[0.05] to-transparent p-[1px] transition-colors duration-500 group-hover:from-copper-400/60 group-hover:via-copper-500/10">
//         <div className="relative flex w-[220px] flex-col overflow-hidden rounded-[calc(1.75rem-1px)] bg-charcoal-900 p-5 shadow-[0_30px_70px_-25px_rgba(0,0,0,0.75)] transition-transform duration-500 ease-out group-hover:-translate-y-1.5 md:w-[270px] md:p-6">
//           {/* Oversized faint number — premium background typography accent */}
//           <span
//             aria-hidden
//             className="pointer-events-none absolute -top-3 right-3 font-display text-7xl font-bold leading-none text-white/[0.045] select-none md:-top-4 md:text-8xl"
//           >
//             {benefit.number}
//           </span>
...
//             style={{
//               background:
//                 "radial-gradient(circle at 15% 0%, rgba(217,119,6,0.16) 0%, transparent 55%)",
//             }}
//           />

//           {/* Image */}
//           <div className="relative mb-5 h-24 w-full overflow-hidden rounded-2xl ring-1 ring-white/[0.06] md:h-28">
//             <Image
//               src={benefit.image}
//               alt={benefit.title}
//               fill
//               sizes="270px"
//               className="object-cover brightness-[0.85] saturate-[0.85] transition-all duration-700 ease-out group-hover:scale-[1.07] group-hover:brightness-100 group-hover:saturate-100"
//             />
...
//             <span className="flex size-4 items-center justify-center rounded-full border border-copper-400/50 transition-colors duration-500 group-hover:border-copper-400">
...
//           <h3 className="relative font-display text-lg uppercase leading-tight tracking-tight text-white transition-colors duration-500 group-hover:text-copper-300 md:text-xl">
//             {benefit.title}
//           </h3>

//           {/* Thin gradient divider */}
//           <span className="relative my-3 block h-px w-full bg-gradient-to-r from-white/15 via-white/5 to-transparent" />

//           <p className="relative text-xs leading-relaxed text-white/50 md:text-sm">
//             {benefit.description}
//           </p>

//           {/* Discreet arrow cue, fades in on hover */}
//           <div className="relative mt-4 flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-[0.12em] text-copper-400 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
