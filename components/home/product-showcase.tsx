...
//           <SectionHeading
//             eyebrow="The Systems"
//             title="One warm floor, multiple ways to get there"
//             lead="Electric mats for quick renovations, water-based systems for whole homes, and smart controls that tie them together."
//             className="text-black [&_p]:text-black/60 [&_span]:text-copper-500"
//           />
//         </div>
      ...
      <div className="container-site">
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-4 flex items-center justify-center gap-3">
            ...
            <span className="font-sans text-[11px] font-medium tracking-[0.25em] text-copper-600 uppercase">
              The Systems
            </span>
            <span className="block h-px w-8 bg-copper-500/50" />
          </div>
          <h2 className="font-display text-4xl leading-tight text-charcoal-900 sm:text-5xl md:text-6xl">
            One <span className="text-copper-500 italic">warm floor</span>,
            <br className="hidden sm:block" /> multiple ways to get there
          </h2>
          <p className="mx-auto mt-5 max-w-md font-sans text-sm leading-relaxed text-charcoal-900/55 md:text-base">
